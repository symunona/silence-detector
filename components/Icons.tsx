...
// Fix: Add 'as const' to ensure TypeScript infers the most specific types for props.
// This resolves the error where 'string' was not assignable to '"round" | "butt" | "square" | "inherit"'.
const iconProps = {
  className: "w-6 h-6",
  viewBox: "0 0 24 24",
  fill: "none",
